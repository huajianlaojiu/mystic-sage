...
export default function Pricing() {
  return <><section className="page-header"><h1>Simple, transparent pricing</h1><p>Two products, two clearly defined outcomes.</p></section>
    <section className="section"><div className="container"><div className="pricing-grid" style={{ maxWidth: 780, margin: "0 auto" }}>
      ...
      <div className="pricing-card featured" style={{ textAlign: "center" }}><div className="badge">Mystic Plus</div><h3>Mystic Plus</h3><div className="subtitle">For deeper ongoing reflection</div><div className="price">$19<span>/mo</span></div><div className="desc">Unlimited readings with a full 10-card spread, plus your reading history. Subject to fair-use and abuse-prevention limits.</div><ul><li>Unlimited readings (no daily limit)</li><li>Full 10-card Celtic Cross every time</li><li>Reading history saved to your account</li><li>Auto-renews monthly until cancelled</li><li>Cancel anytime from your account page</li></ul><PayPalSubForm /><p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 8 }}>Use the same email for PayPal and sign-in so your plan links to your account. Cancel anytime at <a href="/account" style={{ color: "var(--accent)" }}>/account</a>.</p></div>
    </div></div></section>
    <section className="section"><div className="container" style={{ maxWidth: 720, margin: "0 auto" }}><div className="section-tag">One-time report</div><h2 className="section-title">Detailed Tarot Report</h2><p className="section-sub">A written report on a full 10-card Celtic Cross spread, generated after PayPal confirms payment and emailed to the address you pay with.</p><div className="pricing-card" style={{ textAlign: "center", maxWidth: 460, margin: "28px auto 0" }}><h3>Detailed Report</h3><div className="price">$4.99</div><div className="desc">One full report, written for your question. This does not create a subscription.</div><ul style={{ textAlign: "left" }}><li>The big picture of your spread</li><li>Every card explained in depth</li><li>The pattern across your cards</li><li>Timing - what is moving and what needs time</li><li>3 concrete steps to take next</li><li>2 reflective questions to journal on</li></ul><PayPalReportForm /><p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 8 }}>Delivered by email, yours to keep. Sign in on the reading page first if you want it saved to your account.</p></div></div></section>
